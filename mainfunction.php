...
class Database
{
    ...
    function getMechanicDetails($mechanic_id)
    {
        ...
        $query = "SELECT fnum_mechanic_id,fstr_rand_tocken,fstr_mechanic_company_name,fstr_mechanic_name,fstr_mechanic_address,
                      ...
                      fnum_mechanic_contact_mobile_number,fstr_mechanic_executive_name,fstr_mechanic_interest,ExecuutiveRating,
                      ExecutiveRemark,fstr_mechanic_mechanic_picture,fstr_mechanic_shop_outside_picture,fstr_mechanic_shop_inside_picture,
                      fstr_mechanic_other_picture FROM mechanic where fnum_mechanic_id = $mechanic_id";
        ...
        $data_array['ExecuutiveRating'] = $results['ExecuutiveRating'];
        $data_array['ExecutiveRemark'] = $results['ExecutiveRemark'];
        $data_array['fstr_mechanic_mechanic_picture'] = $results['fstr_mechanic_mechanic_picture'];
        $data_array['fstr_mechanic_shop_outside_picture'] = $results['fstr_mechanic_shop_outside_picture'];
        $data_array['fstr_mechanic_shop_inside_picture'] = $results['fstr_mechanic_shop_inside_picture'];
        $data_array['fstr_mechanic_other_picture'] = $results['fstr_mechanic_other_picture'];
